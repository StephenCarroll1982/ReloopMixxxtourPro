// Full enhanced JS mapping as in canvas
var MixtourPro = {
    deck: 1,
    padMode: 0,
    shift: false,
    hotcueColors: [0x03,0x0C,0x30,0x3F,0x3C,0x06,0x09,0x12],
    RGB: {off:0x00,red:0x30,green:0x0C,blue:0x03,yellow:0x3C,white:0x3F}
};
...
MixtourPro.sendLED = function(status, control, value) {
...
// Additional functions omitted for brevity (browser, mode button, deck switching)
